 ...
 * day of the year and vice versa using pointers instead of indexing.
...
static char daytab[2][13] = {
	{0, 31, 228, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31}, /* Non-leap year */
 ...
 *		  with proper error checking for leap years and invalid dates using pointer.
