/*
 * Custom Standard I/O Library Implementation
...
#define EOF     (-1)
#define BUFSIZ  1024
#define OPEN_MAX 20    /* Max open files open at once */
...
/*
 * fopen	: Open file and return a file pointer.
 * Input	: name (File name), mode (File mode: 'r', 'w', 'a')
 ...
 * Return	: Next character in the buffer, EOF on failure.
 * Author	: Dhruv Ajudiya
 * Created	: 28 November 2024
 * Modified	: 28 November 2024
 */
...
/*
 * _flushbuf	: Flush the buffer to the file.
 * Input	: c (Character to flush), f (File pointer)
 * Return	: Flushed character on success, EOF on failure.
 * Author	: Dhruv Ajudiya
 * Created	: 28 November 2024
 * Modified	: 28 November 2024
 */
 ...
 * Input	: f (File pointer), offset (Offset to seek), whence (Position reference)
...
/** MAIN PROGRAM */
/*
 * main	: Example program using custom stdio library.
 */
